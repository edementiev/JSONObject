...
2.3
- Использована Sendable struct вместо class, для более простого использования в многопоточности

2.4
- Обновил тесты

2.5
- Сделал возможность использования имени ключа/переменной с точкой, иначе она работает как разделитель, для этого требуется использовать rawName: true
- Обновил тесты
...
2.5.2
- Отказался от идеи использовать rawName, вместо этого сделал возможность задавать разделитель в виде любого символа
- Обновил тесты

2.5.3
- Добавил поддержку возможности задать разделитель в array 
